...
<g:textField name="miContacto.nombre" value="${institucionInstance?.miContacto?.nombre}"/></p>

<p><label for="miContacto.email">
    <g:message code="institucion.miContacto.email.label" default="Email" />
    <span class="required-indicator">*</span>
  </label>
<g:textField name="miContacto.email" value="${institucionInstance?.miContacto?.email}"/></p>

<p><label for="miContacto.telefono">
    <g:message code="institucion.miContacto.telefono.label" default="Telefono" />
    <span class="required-indicator">*</span>
  </label>
<g:textField name="miContacto.telefono" value="${institucionInstance?.miContacto?.telefono}"/></p>
</div>
